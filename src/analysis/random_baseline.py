...
def gerar_estrategia_aleatoria(df_dados: pd.DataFrame,prob_troca: float = 0.03,seed: int | None = None,) -> pd.DataFrame:
    """
...
def main():
    ...
    #estratégia aleatória com turnover controlado
    ...
    resultados_random = []
    turnovers_random = []
    print(f"Iniciando {NUM_SIMULACOES_RANDOM} simulações aleatorias")
